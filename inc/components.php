...
function ci_social_icon_svg( $label, $url = '' ) {
	...
	if ( false !== strpos( $str, 'wordpress' ) || false !== strpos( $str, 'wp' ) ) {
		return '<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor"><path d="M12.158 12.786l-2.698 7.84c.484.152.997.234 1.54.234 1.831 0 3.498-.718 4.733-1.892l-3.575-6.182zm-4.309-3.953l-3.327 9.07c-1.393-1.57-2.242-3.636-2.242-5.903 0-2.825 1.319-5.342 3.376-6.974l2.193 3.807zm12.39-1.293c.189.697.3 1.458.3 2.46 0 1.578-.574 3.447-1.464 5.34l-1.637-4.786 1.761-2.032.04-.982zm-8.239-5.54c5.523 0 10 4.477 10 10 0 1.258-.232 2.463-.655 3.576l-.089.176-3.801-10.988c.414-.047.886-.094.886-.094.464-.047.417-.734-.047-.734 0 0-1.346.142-2.244.142-.851 0-2.243-.142-2.243-.142-.464 0-.511.687-.047.734 0 0 .472.047.886.094l2.115 5.811-2.969 8.878L4.254 6.746c.414-.047.886-.094.886-.094.464-.047.417-.734-.047-.734 0 0-1.346.142-2.244.142-.236 0-.543-.01-.861-.027C3.992 3.631 7.683 2 12 2z"/></svg>';
	}
