...
function ci_register_fields() {
	...
	ci_group(
		...
		array_merge(
			array(
				...
				ci_t( 'opt_footer_explore', 'Navigation column title', 'Navigation' ),
				ci_t( 'opt_footer_caps_title', 'Capabilities column title', 'Key Capabilities' ),
				ci_ta( 'opt_footer_capabilities', 'Capabilities list (one per line)', "Strategic Storytelling\nSocial Media Marketing\nPerformance Marketing\nSEO, AI Search\nLocal Visibility\nContent, Creative\nCampaigns\nBranding\nDesign\nWebsites\nDigital Experiences\nPodcast Production\nMarketing" ),
				ci_t( 'opt_footer_locs_title', 'Locations column title', 'Locations' ),
				ci_t( 'opt_footer_contact_title', 'Contact column title', 'Direct Contact' ),
				ci_t( 'opt_email_2', 'Second email address', 'aashit.shah@ci360degrees.com' ),
	...
	ci_group(
		...
		array(
			...
			ci_ta( 'service_summary', 'Summary / Hero Lead' ),
			ci_t( 'service_headline', 'Hero Title Accent / Headline' ),
			ci_ta( 'service_body', 'Body', '', array( 'rows' => 5 ) ),
			ci_t( 'service_overview_heading', 'Overview Heading', 'Turn Conversations Into Communities' ),
			ci_ta( 'service_overview_copy', 'Overview Copy', 'Social media is more than just posting — it\'s about people, conversations, and real connections. We help brands show up with purpose, create engaging content, and build communities that drive meaningful business results.' ),
			ci_rep( 'service_overview_features', 'Overview Features (3 Cards)', array( ci_t( 'title', 'Title' ), ci_ta( 'text', 'Text' ) ) ),
			ci_t( 'service_highlights_title', 'Service Highlights Title', 'Service Highlights' ),
			ci_rep( 'service_highlights_list', 'Service Highlights Bullet Points', array( ci_t( 'item', 'Highlight Item' ) ) ),
			ci_t( 'service_included_heading', 'What\'s Included Heading', 'Everything You Need to Grow on Social' ),
			ci_rep( 'service_included_cards', 'What\'s Included Grid Cards', array( ci_t( 'title', 'Title' ), ci_ta( 'text', 'Text' ), ci_f( 'image', 'image', 'Thumbnail' ) ) ),
			ci_t( 'service_approach_heading', 'Our Approach Heading', 'A Strategic, Results-Driven Process' ),
			ci_rep( 'service_steps', 'Our Approach Process Steps', array( ci_t( 'title', 'Title' ), ci_ta( 'text', 'Text' ) ) ),
			ci_t( 'service_cta_heading', 'CTA Banner Heading', 'Ready to grow your brand on social media?' ),
			ci_ta( 'service_cta_sub', 'CTA Banner Subtext', 'Our team is here to understand your goals and create a tailored strategy that drives real results.' ),
